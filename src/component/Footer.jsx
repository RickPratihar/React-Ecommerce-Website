...
const tweetList = [
  {
    ...
    desc: (
      <p>
        Rick Pratihar <a href="#">@ShopCart Greetings! #Today best deal</a> Grab
  ...
  },
  {
    ...
    desc: (
      <p>
        Rick Pratihar <a href="#">@ShopCart Hey! #Sel ! sel ! sel...</a> Grab your
      ...
      <div className="footer-bottom">
        <div className="container">
            <div className="section-wrapper">
                <p>&copy; 2024<Link to='/'>Shop Cart</Link>Designed by <a href="/" target="_blank">Rick Pratihar</a></p>
